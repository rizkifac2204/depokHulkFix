...
const LaporanPrintPenyampaian = React.forwardRef(({ detail }, ref) => {
  ...
  return (
    <ThemeProvider theme={themeLight}>
      <Card sx={{ display: "none", displayPrint: "block" }} ref={ref}>
        ...
        >
          <Box sx={{ position: "relative" }}>FORMULIR MODEL B.3</Box>
        </Box>
        ...
        <Typography variant="h5" align="center">
          TANDA BUKTI PENYAMPAIAN LAPORAN <br />
          Nomor {detail.nomor}
        </Typography>
...
LaporanPrintPenyampaian.displayName = "LaporanPrintPenyampaian";
export default LaporanPrintPenyampaian;
