...
const handleSubmit = (values, setSubmitting) => {
  axios
    .post(`/api/pelanggaran/laporan`, values)
    .then((res) => {
...
function LaporanFormAdd() {
  ...
  function setAutoValue(newValue) {
    if (newValue !== null) {
      ...
      formik.setFieldValue("kewarganegaraan", newValue.kewarganegaraan);
    } else {
      ...
      formik.setFieldValue("kewarganegaraan", "");
    }
  }
