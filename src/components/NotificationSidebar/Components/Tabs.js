...
export default function FullWidthTabs(props) {
  ...
  const updateSearch = (e) => {
    if (e.target.value === "") {
      ...
      let searchedQues = documentation.filter(
        (ques, i) =>
          ...
          <Box className="quick-doc">
              ...
              documentation.map((data, i) => (
                <Box className="quick-doc-block" key={i}>
                  ...
                  <a
                    ...
                    className="quick-doc-link"
                    href="https://docs.theironnetwork.org/hulk/"
                  >
                    {data.link}
                  </a>
                </Box>
            ...
            <Box className="quick-doc-block quick-doc-help">
              ...
              <Typography variant="body2">
                We are provide online Documentation for hulk. Please check the
                following link to know more{" "}
              </Typography>
              <a
                target="_blank"
                rel="noopener noreferrer"
                ...
                href="https://docs.theironnetwork.org/hulk/"
              >
                https://docs.theironnetwork.org/hulk/
              </a>
            </Box>
          </Box>
        </div>
