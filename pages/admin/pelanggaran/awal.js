...
import PelanggaranAwalDetail from "components/Pelanggaran/PelanggaranAwalDetail";
...
async function deleteData(id) {
  if (id) {
    try {
      const res = await axios.delete(`/api/pelanggaran/awal/${id}`);
      return res.data;
    } catch (err) {
...
function LaporAwal() {
  ...
  const {
    ...
    queryFn: ({ signal }) =>
      axios
        .get(`/api/pelanggaran/awal`, { signal })
        .then((res) => res.data)
        .catch((err) => {
